            ...
            if (detailPokemonResponse != null){
                switch (detailPokemonResponse.status){
                    ...
                    case SUCCESS:
                        ...
                        binding.tvPokemonHeight.setText(Helper.getHeight(detailPokemonResponse.data.getHeight()));
                        binding.tvPokemonWeight.setText(Helper.getWeight(detailPokemonResponse.data.getWeight()));
